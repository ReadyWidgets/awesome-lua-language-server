...
---@field current_client? client._static Get the client currently under the mouse cursor.
---@field current_wibox? wibox._static Get the wibox currently under the mouse cursor.
